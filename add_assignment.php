...
if (!$course) {
    header('location: educator_panel.php?error=' . urlencode('Course not found or you are not authorized to add assignments to this course'));
    exit;
}
?>
...
include "header.php";
?>
<title>Add Assignment | GoLearn</title>
    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <div class="container p-5">
                ...
                <form action="utils/_handle_add_assignment.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group my-2">
                        ...
                        <textarea name="assignment_description" class="form-control" required></textarea>
                    </div>
                    <div class="form-group my-2">
                        <label for="assignment_material" class="form-label">Assignment Material:</label>
                        <input type="file" name="assignment_material" class="form-control" required>
                    </div>
